...
class ProfileSerenicia(models.Model):
    ...
    bacterium = models.BooleanField(default=False, verbose_name=_('Bacterium'))
    date_status_deceased = models.DateField(null=True, blank=True, default=None, verbose_name=_('Date status deceased'))
    UP_volunteer = models.BooleanField(default=False, verbose_name=_('UP Volunteer'))
    passphrase = models.FileField(upload_to=upload_passphrase, null=True, blank=True, verbose_name=_('Pass phrase'))
    word_played = models.PositiveIntegerField(default=0, verbose_name=_('Word played'))
    total_score = models.PositiveIntegerField(default=0)
    meal_type = models.ForeignKey(PresentationType, on_delete=models.SET_NULL, blank=True, null=True, verbose_name=_('Meal type'))
